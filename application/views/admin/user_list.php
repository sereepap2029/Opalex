      ...
      <table class="table table-bordered">
        ...
        foreach ($user_list as $key => $value) {
          ...
          <tr>
            ...
            <td>
              <button type="button" class="btn btn-secondary" onclick="location.href='<?=site_url("admin/admin_user/create/".$value->id)?>';">แก้ไข</button>
              <button type="button" class="btn btn-danger" onclick="deleteconfirm('<?=site_url("admin/admin_user/delete/".$value->id)?>')">ลบ</button>
            </td>
          </tr>
          <?
        }
